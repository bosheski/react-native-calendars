...
export default class TimelineCalendarScreen extends Component {
  ...
  createNewEvent: TimelineWVProps['onBackgroundLongPress'] = (timeString, timeObject) => {
  ...
  approveNewEvent: TimelineWVProps['onBackgroundLongPressOut'] = (_timeString, timeObject) => {
    const {eventsByDate} = this.state;
  ...
  private timelineProps: Partial<TimelineWVProps> = {
    format24h: true,
    ...
    return (
      ...
      >
        <ExpandableCalendar
          ...
          markedDates={{
            markedDates: {disabled: true, disableTouchEvent: true}
          }}
        />
        <TimelineListWV
          events={eventsByDate}
